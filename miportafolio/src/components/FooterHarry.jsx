...
function FooterHarry() {
  return (
    <div className="contenedorFooterHarry">
      <div>
        <p className="textoFooterHarry">
          Editado con amor y magía por{" "}
          <span className="carlaDiazHarry"> &nbsp;Carla Díaz </span>
          <span className="bolaCristalHarry"> &nbsp;🔮</span>
        </p>
        <div className="inconosFooterHarry">
          <a target="_blank" href="https://github.com/Carlareneedc">
            <img className="git" alt="git" src={gitHub} />
          </a>
          <a target="_blank" href="https://www.linkedin.com/in/carladiazc/">
