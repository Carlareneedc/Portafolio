      ...
      <div className={style.contenedorCardsJapan}>
        <CardDeck style={{ borderRadius: "20px" }}>
          ...
          >
            ...
            <Card.Body>
              <Card.Title>
                <h5 className={style.pincelBookJapan}>GAV</h5>
              </Card.Title>
              <Card.Text>
                <p className={style.redSocialJapan}>
                ...
                >
                  <Button
                    className={style.verProyectoJapan}
                    style={{
                      borderColor: "#FF3C38",
          ...
          >
            ...
            <Card.Body>
              <Card.Title>
                <h5 className={style.harryPotterJapan}>
                  Harry Potter Beginners
                </h5>
              </Card.Title>
              <Card.Text>
                <p className={style.appInformativaJapan}>
                ...
                <Link to="/HarryPotter">
                  <Button
                    className={style.verProyectoJapanCont}
                    style={{
                      borderColor: "#FF3C38",
                      backgroundColor: "#FF3C38",
                      fontWeight: "bold",
