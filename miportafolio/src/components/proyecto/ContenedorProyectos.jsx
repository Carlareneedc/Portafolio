      ...
      <div className={style.contenedorCards}>
        <CardDeck style={{ borderRadius: "20px" }}>
          ...
          >
            ...
            <Card.Body>
              <Card.Title>
                <h5 className={style.japanQueen}>Japan Queen</h5>
              </Card.Title>
              <Card.Text>
                <p className={style.appPara}>
                  App para restaurantes que se origina como solución a la
                  gestión de pedidos, eliminando el uso de comandas y toma de
                  ordenes a mano.
                </p>
                <Link className="linkJapan" to="JapanQueen">
                  <Button
                    className={style.verProyectoUno}
                    style={{
                      borderColor: "#FF3C38",
          ...
          >
            ...
            <Card.Body>
              <Card.Title>
                <h5 className={style.pincelBook}>GAV</h5>
              </Card.Title>
              <Card.Text>
                <p className={style.redSocial}>
                  Sitio gamificado en donde se entrega información sobre el
                  covid-19. Desarrollado para padres y tutores de niños entre 4
                  a 7 años.
                </p>
                <a
                  target="_blank"
                  href="https://ganemoslealcorona.netlify.app/"
                >
                  <Button
                    className={style.verProyecto}
                    style={{
                      borderColor: "#FF3C38",
                      backgroundColor: "#FF3C38",
                      fontWeight: "bold",
          ...
          >
            ...
            <Card.Body>
              <Card.Title>
                <h5 className={style.harryPotter}>Harry Potter Beginners</h5>
              </Card.Title>
              <Card.Text>
                <p className={style.appInformativa}>
                  App informativa, cuyo enfoque principal es mostrar datos
                  claves para conocer a grandes rasgos, el universo de Harry
                  Potter
                </p>
                <Link to="/HarryPotter">
                  <Button
